...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if(!await orAction.reduce(interaction.user.id, this.price)) {
            const embed = createEmbeds.createFullEmbed('Il manque quelque chose..', 'Vous n\'avez pas assez d\'argent pour changer de couleur ! Economisez ' + this.price + ' pièces d\'or et revenez me voir !', null, null, null, null);
